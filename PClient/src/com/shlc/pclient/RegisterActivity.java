...
public class RegisterActivity extends Activity implements android.view.View.OnClickListener, OnTouchListener, OnDateSetListener {
	...
	private TextView et_birthday_modify, et_birthday_show,et_bornyear;
	private int mYear;  
    private int mMonth;  
    private int mDay; 
	@Override
	...
	private void initView(){
		...
		et_bornyear = (TextView)findViewById(R.id.rg_bornyear);
		et_bornyear.setOnClickListener(this);
		
		Intent intent = getIntent();
		String message = intent.getStringExtra(RegisterAgeActivity.BORN_YEAR);
		if(message != null){
			et_bornyear.setText(message);
		}		
...
//		
	...
	public void onClick(View v) {
		// TODO Auto-generated method stub
		switch(v.getId()){
		case R.id.rg_bornyear:
			Intent intent = new Intent(RegisterActivity.this,RegisterAgeActivity.class);
			startActivity(intent);
			overridePendingTransition(R.anim.in_from_right, R.anim.bottom_activity);
			break;
